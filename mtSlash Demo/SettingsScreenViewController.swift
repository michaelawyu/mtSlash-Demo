...
class SettingsScreenViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func initTableViewCellAtGivenIndexPath(indexPath: NSIndexPath) -> UITableViewCell {
        ...
        case (0, 0):
            ...
            let currentFont = self.getCurrentSettingFromDatabase().1
        ...
        case (0, 2):
            ...
            let currentFontSize = self.getCurrentSettingFromDatabase().0
    ...
    func getCurrentSettingFromDatabase() -> (Fonts.SupportedFontSizes, Fonts.SupportedFonts) {
